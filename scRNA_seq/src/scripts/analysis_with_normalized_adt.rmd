---
title: "STOC SC Analysis ADT Normalization"
...
save_dir <- paste0(base_dir, "results/R_analysis/antibody_normalization/")
...
```{r,results="hide"}
stoc_data <- readRDS("results/R_analysis/stoc_dsb_normalized.rds")
```
...
umap_data <- group_cells(stoc_data, "STOC1", save_dir, nPCs = 12,
